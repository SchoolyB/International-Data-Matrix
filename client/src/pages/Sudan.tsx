...
import flag from '../../assets/countryPageFlags/pngs/sdn.png'

export default function Sudan() {
  return (
    <div className='overallCountryInfoCOntainer'>
      <div className="countryInfo" id="SudanInfo">
      ...
      <section className="currentEvents topic" id="SudanCurrentEvents">
