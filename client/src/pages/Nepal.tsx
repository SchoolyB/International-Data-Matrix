...
import flag from '../../assets/countryPageFlags/pngs/npl.png'

export default function Nepal() {
  return (
    <div className='overallCountryInfoCOntainer'>
      <div className="countryInfo" id="NepalInfo">
      ...
      <section className="currentEvents topic" id="NepalCurrentEvents">
