...
import flag from '../../assets/countryPageFlags/pngs/ven.png'

export default function Venezuela() {
  return (
    <div className='overallCountryInfoCOntainer'>
      <div className="countryInfo" id="VenezuelaInfo">
      ...
      <section className="currentEvents topic" id="VenezuelaCurrentEvents">
