...
import flag from '../../../assets/countryPageFlags/svgs/cod.svg'


export default function Democratic_Republic_Of_The_Congo() {
  return (
    <div className='overallCountryInfoCOntainer'>
      <div className="countryInfo" id="Democratic_Republic_Of_The_CongoInfo">
        <img className="longCountryInfoFlag"
        id="Democratic_Republic_Of_The_CongoInfoFlag"
        src={flag}
        alt="The
        Flag
        of
