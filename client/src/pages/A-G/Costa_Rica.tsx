...
import flag from '../../../assets/countryPageFlags/svgs/cri.svg'


export default function Costa_Rica() {
  return (
    <div className='overallCountryInfoCOntainer'>
      <div className="countryInfo" id="Costa_RicaInfo">
        <img className="longCountryInfoFlag"
        id="Costa_RicaInfoFlag"
        src={flag}
        alt="The
        Flag
        of
