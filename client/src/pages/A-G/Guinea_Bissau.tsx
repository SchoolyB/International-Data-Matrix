...
import flag from '../../../assets/countryPageFlags/svgs/gnb.svg'


export default function Guinea_Bissau() {
  return (
    <div className='overallCountryInfoCOntainer'>
      <div className="countryInfo" id="Guinea_BissauInfo">
        <img className="longCountryInfoFlag"
        id="Guinea_BissauInfoFlag"
        src={flag}
        alt="The
        Flag
        of
