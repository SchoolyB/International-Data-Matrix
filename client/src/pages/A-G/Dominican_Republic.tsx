...
import flag from '../../../assets/countryPageFlags/svgs/dom.svg'


export default function Dominican_Republic() {
  return (
    <div className='overallCountryInfoCOntainer'>
      <div className="countryInfo" id="Dominican_RepublicInfo">
        <img className="longCountryInfoFlag"
        id="Dominican_RepublicInfoFlag"
        src={flag}
        alt="The
        Flag
        of
