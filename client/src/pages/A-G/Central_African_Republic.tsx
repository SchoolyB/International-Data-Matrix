...
import flag from '../../../assets/countryPageFlags/svgs/caf.svg'


export default function Central_African_Republic() {
  return (
    <div className='overallCountryInfoCOntainer'>
      <div className="countryInfo" id="Central_African_RepublicInfo">
        <img className="longCountryInfoFlag"
        id="Central_African_RepublicInfoFlag"
        src={flag}
        alt="The
        Flag
        of
