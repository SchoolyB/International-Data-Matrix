...
import flag from '../../assets/countryPageFlags/pngs/grc.png'


export default function Greece() {
  return (
    <div className='overallCountryInfoCOntainer'>
      <div className="countryInfo" id="GreeceInfo">
      ...
      <section className="currentEvents topic" id="GreeceCurrentEvents">
