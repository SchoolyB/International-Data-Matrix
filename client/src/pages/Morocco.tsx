...
import flag from '../../assets/countryPageFlags/pngs/mar.png'


export default function Morocco() {
  return (
    <div className='overallCountryInfoCOntainer'>
      <div className="countryInfo" id="MoroccoInfo">
      ...
      <section className="currentEvents topic" id="MoroccoCurrentEvents">
